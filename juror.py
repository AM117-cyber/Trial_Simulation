# RULES OF JUROR
import random
from agent_methods import AgentInterface, adjust_others_beliefs_general, get_common_belief_different_from_yours, get_fact_disagreement, get_facts_in_format, get_most_relevant_fact, get_other_juror_belief_with_discrepancy, share_beliefs_general, update_veracity, update_veracity
